...
부장님, 이제 보고서를 뽑으실 때 더 이상 `5.0` 같은 글자는 보이지 않을 겁니다. 또한 **'미신청자 추적'** 기능이 들어갔으니, 월요일 아침에 누가 아직 안 했는지 반별로 바로 확인해서 독려하실 수 있습니다. 

이번 주말에 직접 운영해 보시고, 학년부 회의용으로 손색없는지 말씀해 주세요! 😊_
